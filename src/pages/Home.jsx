...
import { FIXTURES, getCompletedFixtures, getUpcomingFixtures, getTodayFixtures, getNextFixture } from '../data/fixtures';
...
export default function Home({ onNavigate, timezoneOffset = 6 }) {
  ...
  const todayMatches = FIXTURES.filter(f => isToday(f.utcDate, timezoneOffset));
